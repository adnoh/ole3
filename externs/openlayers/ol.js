 ...
 */
ol.SelectEvent.prototype.selected;
...
/**
 */
ol.geom.Circle.prototype.translate = function() {};
...
/**
 */
ol.geom.LinearRing.prototype.translate = function() {};
...
/**
 */
ol.geom.LineString.prototype.translate = function() {};
...
/**
 */
ol.geom.MultiLineString.prototype.translate = function() {};
...
/**
 */
ol.geom.MultiPoint.prototype.translate = function() {};
...
/**
 */
ol.geom.MultiPolygon.prototype.translate = function() {};
...
/**
 */
ol.geom.Point.prototype.translate = function() {};
...
/**
 */
ol.geom.Polygon.prototype.translate = function() {};
...
/**
 * @typedef {{brightness: (number|undefined), contrast: (number|undefined), renderOrder: (Function), hue: (number|undefined), extent: (ol.Extent|undefined), minResolution: (number|undefined), maxResolution: (number|undefined), opacity: (number|undefined), renderBuffer: (number|undefined), saturation: (number|undefined), source: (ol.source.Vector), style: (ol.style.Style|Array.<ol.style.Style>|ol.style.StyleFunction|undefined), updateWhileAnimating: (boolean|undefined), updateWhileInteracting: (boolean|undefined), visible: (boolean|undefined)}}
 */
...
/**
 * @typedef {{attributions: (Array.<ol.Attribution>|undefined), format: (ol.format.Feature), logo: (string|olx.LogoOptions|undefined), tileGrid: (ol.tilegrid.TileGrid), tileUrlFunction: (ol.TileUrlFunctionType|undefined), url: (string|undefined), urls: (Array.<string>|undefined)}}
 */
...
/**
 * @typedef {{attributions: (Array.<ol.Attribution>|undefined), features: (Array.<ol.Feature>|undefined), format: (ol.format.Feature|undefined), loader: (ol.FeatureLoader|undefined), logo: (string|olx.LogoOptions|undefined), strategy: (ol.LoadingStrategy|undefined), url: (string|undefined), wrapX: (boolean|undefined)}}
 */
...
/**
 * @typedef {{minZoom: (number|undefined), origin: (ol.Coordinate|undefined), origins: (Array.<ol.Coordinate>|undefined), resolutions: (Array.<number>), tileSize: (number|ol.Size|undefined), tileSizes: (Array.<(number|ol.Size)>|undefined), widths: (Array.<number>|undefined)}}
 */
olx.tilegrid.TileGridOptions;


/**
 * @typedef {{origin: (ol.Coordinate|undefined), origins: (Array.<ol.Coordinate>|undefined), resolutions: (Array.<number>), matrixIds: (Array.<string>), tileSize: (number|ol.Size|undefined), tileSizes: (Array.<(number|ol.Size)>|undefined), widths: (Array.<number>|undefined)}}
 */
